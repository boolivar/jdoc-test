...
public class JdocCucumberTask extends DefaultTask {
    ...
    private final JdocCucumberGenerateAction generateAction;

    @Inject
    public JdocCucumberTask(ObjectFactory objectFactory) {
        this(objectFactory.property(SourceDirectorySet.class), objectFactory.property(String.class), objectFactory.directoryProperty(), new JdocCucumberGenerateAction());
    }

    public JdocCucumberTask(Property<SourceDirectorySet> sources, Property<String> langTag, DirectoryProperty outputDir, JdocCucumberGenerateAction generateAction) {
