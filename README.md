...
dependencies {
    <!-- x-release-please-version -->testRuntimeOnly "io.github.boolivar.jdoctest:jdoc-cucumber:0.10.1"
...
plugins {
    id "java"
    id "io.github.boolivar.jdoctest.jdoc-cucumber" version "0.10.1"
}
