...
class JdocTaskTest {
    ...
    @Mock
    private JdocGenerateAction generateAction;
    ...
    void setupTask() {
        ...
        task = JdocTask.injectIntoNewInstance(project, identity, () -> new JdocTask(sources, langTag, outputDir, generateAction));
    }
    ...
    void testGenerateFeatures(@Mock SourceDirectorySet sourceSet, @Mock Directory dir, @Mock InputChanges changes) {
        ...
        assertThatNoException()
            .isThrownBy(() -> task.generate(changes));
